export const common = {
  dataSource: {
    ...
    supabase: "Supabase",
    sessionUnavailable: "The Supabase sign-in session could not be restored.",
    noWorkspaces: "This account has no available workspace, so the home page cannot open.",
